...
class Task(Base):
    ...
    org: Mapped[Org | None] = relationship(back_populates="tasks", init=False, default=None)
    run: Mapped[Run | None] = relationship(back_populates="tasks", init=False, default=None)
